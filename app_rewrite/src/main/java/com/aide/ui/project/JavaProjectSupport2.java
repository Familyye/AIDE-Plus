...
class JavaProjectSupport2 implements ProjectSupport {
	...
	public String getProjectAttributeHtmlString() {
		try {
			String str = ("<b>Java Project:</b><br/><br/>" + ServiceContainer.getProjectService().getCurrentAppHome()
					+ "<br/><br/>") + "<i>Library JARs:</i><br/><br/>";
	...
	public TemplateService.TemplateGroup[] getTemplateGroups() {
		...
		try {
			...
			if (!ServiceContainer.isAggregateVersion() && !ServiceContainer.appId.equals("com.aide.ui")) {
				z = false;
				return new TemplateService.TemplateGroup[]{new TemplateService.TemplateGroup("Java Application",
						new TemplateService.Template(this, 3, "Java Application", "Java", "MyJavaConsoleApp", false,
								false, "com.aide.ui", "JAVA", "course_java", z),
						0x7f07007b, "JavaConsole.zip", new String[]{"Main.java"}, (String) null)};
			}

			z = true;
			return new TemplateService.TemplateGroup[]{new TemplateService.TemplateGroup("Java Application",
					new TemplateService.Template(this, 3, "Java Application", "Java", "MyJavaConsoleApp", false, false,
							"com.aide.ui", "JAVA", "course_java", z),
					0x7f07007b, "JavaConsole.zip", new String[]{"Main.java"}, (String) null)};
		} catch (Throwable th) {
			if (exceptionEnabled) {
	...
	public boolean isPremium() {
		try {
			...
			if (c0.Ws(ServiceContainer.getMainActivity(), "AllowSavingOneJavaFileInNonPremium",
	...
	public EngineSolution makeEngineSolution() {
		try {
			...
			return MakeJavaEngineSolution.DW(ServiceContainer.getProjectService().getCurrentAppHome(),
					ServiceContainer.getProjectService().getAndroidJarPath(), (String) null);
		} catch (Throwable th) {
			if (exceptionEnabled) {
