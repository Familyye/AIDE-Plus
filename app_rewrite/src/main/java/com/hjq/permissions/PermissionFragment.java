...
public final class PermissionFragment extends Fragment implements Runnable {
    ...
    public static void launch( Activity activity,  List<String> permissions,
                                 OnPermissionInterceptor interceptor,  OnPermissionCallback callback) {
     ...
     */
    public void splitTwiceRequestPermission( Activity activity,  List<String> allPermissions,
         List<String> firstPermissions, int requestCode) {
